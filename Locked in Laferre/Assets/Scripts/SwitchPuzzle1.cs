...
public class SwitchPuzzle1 : MonoBehaviour {
    ...
    {
        if (state == SwitchPuzzle1.State.on)
            TurnOff();
        else
            TurnOn();
    }
    ...
    private void TurnOn()
    {
        ...
        state = SwitchPuzzle1.State.on;
        Box.GetComponent<MoveBox>().changeValue(1, 1);
    }
    ...
    private void TurnOff()
    {
        ...
        state = SwitchPuzzle1.State.off;
        Box.GetComponent<MoveBox>().changeValue(1, 0);
