...
public class SwitchPuzzle3 : MonoBehaviour {
    ...
    {
        if (state == SwitchPuzzle3.State.on)
            TurnOff();
        else
            TurnOn();
    }
    ...
    private void TurnOn()
    {
        ...
        state = SwitchPuzzle3.State.on;
        Box.GetComponent<MoveBox>().changeValue(3, 1);
    }
    ...
    private void TurnOff()
    {
        ...
        state = SwitchPuzzle3.State.off;
        Box.GetComponent<MoveBox>().changeValue(3, 0);
